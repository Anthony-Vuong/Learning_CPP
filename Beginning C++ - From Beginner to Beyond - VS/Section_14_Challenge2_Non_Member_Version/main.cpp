...
int main()
{
    ...
    Mystring larry3{ "Larry" };     // Overloaded constructor called
    Mystring moe1{ "Moe" };         // Overloaded constructor called

    Mystring stooge = larry3;       // Not assignment, so copy constructor called
    larry3.display();
    moe1.display();
    ...
    std::cout << "Larry and moe are equal: \t\t" << std::boolalpha << (larry3 == moe1) << std::endl;        // Calls (==) overloaded operator
    std::cout << "Larry and stooge are equal: \t\t" << (larry3 == stooge) << std::endl;
    ...
    std::cout << "Larry and moe are not equal: \t\t" << std::boolalpha << (larry3 != moe1) << std::endl;        // Calls (!=) overloaded operator
    std::cout << "Larry and stooge are not equal: \t" << (larry3 != stooge) << std::endl;
