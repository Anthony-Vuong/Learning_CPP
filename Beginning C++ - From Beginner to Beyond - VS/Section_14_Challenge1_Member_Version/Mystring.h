...
class Mystring
{
	...
	// Overloading (==) operator
	friend bool operator==(const Mystring& lhs, const Mystring& rhs);				// equality operation on string

	// Overloading (!=) operator
	friend bool operator!=(const Mystring& lhs, const Mystring& rhs);				// equality operation on string

	// Overloading (<) operator
	friend bool operator<(const Mystring& lhs, const Mystring& rhs);				// less than operation on string

	// Overloading (>) operator
	friend bool operator>(const Mystring& lhs, const Mystring& rhs);				// more than operation on string
